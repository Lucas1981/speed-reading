...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        timeLeft() {
            ...
            let wordsLeft = this.sourceText.length - this.index;
            let speed = this.speed / 1000;
            let base = wordsLeft * speed / 60;
